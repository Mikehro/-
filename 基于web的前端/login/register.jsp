...
<body>
	<div class="div">
        ...
        <div class="sign-div">
            <form class="form-horizontal" action="register1.jsp" method="post">
                <h1>注册</h1>
                ...
                <input class="input-text1" type="text" name="validate"placeholder="验证码">
                <img class="validate" src="validate.jsp" onclick="this.src=this.src+'?'+Math.random()" id="img">
                <div align="left" style="float:left">
                     <input class="input-btn1" type="submit" value="注册">
                </div>
                <div align="right">
                <input class="input-btn2" type="button" value="返回"onclick="window.location.href='login.jsp';">
                </div>
